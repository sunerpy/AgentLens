...
export function HostsView() {
  ...
  const statuses = useQuery({ queryKey: REFRESH_STATUS_QUERY_KEY, queryFn: getRefreshStatus })
      ...
      {failure !== null ? (
        ...
        <>
          ...
          {hosts.isPending || statuses.isPending ? (
            ...
            <HostList rows={rows} selectedHostId={selectedHostId} onSelect={setSelectedHostId} />
          )}
        </>
      )}
    </section>

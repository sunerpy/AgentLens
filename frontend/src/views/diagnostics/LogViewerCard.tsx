      ...
      <CardContent className="flex flex-col gap-3">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Button
            ...
            onClick={() => {
              navigator.clipboard.writeText(entriesToText(entries, timezone)).then(
                () => setCopied(true),
                () => setCopied(false),
              )
            }}
        ...
        <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-muted-foreground">
          <span data-testid="diagnostics-log-timezone" className="font-medium text-foreground">
            {zh.diagnostics.logs.timezoneLabel(timezone)}
          </span>
          <span className="select-none">{zh.diagnostics.logs.timezoneHint}</span>
        </div>
            ...
            {entries.map((entry, index) => (
              ...
              >
                <div className="flex flex-wrap items-center gap-2 font-mono text-[0.7rem] text-muted-foreground">
                  ...
                  <span data-testid="diagnostics-log-time">

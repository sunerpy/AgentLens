...
export const zh = {
  ...
  settings: {
    ...
    update: {
      ...
      proxy: '更新代理（可选）',
      proxyHint:
        '留空时使用系统代理或 HTTP_PROXY / HTTPS_PROXY / ALL_PROXY 环境变量，均未配置时直连；支持 http://、https://、socks5:// 和 URL 内认证',
      proxyPlaceholder: '例如：http://127.0.0.1:7890',
      proxySystem: '系统 / 环境变量',
      proxyCustom: '自定义代理',
      proxyMalformed: '请输入包含协议和主机的完整代理 URL',
      proxyUnsupportedScheme: '仅支持 http://、https://、socks5:// 代理',
      proxyUnsupportedShape: '代理 URL 不能包含路径、查询参数或片段',
      check: '检查更新',
      checking: '正在检查…',

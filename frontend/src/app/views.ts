 ...
 * is five sibling tabs in one desktop window with no deep links, no nested routes and no
 ...
 */
export const VIEW_KEYS = ['overview', 'drilldown', 'detail', 'hosts', 'settings'] as const
